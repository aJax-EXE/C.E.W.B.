classdef ArduinoSerialTestD < matlab.System
    ...
    methods (Access = protected)
        ...
        function [enc_out, v_out] = stepImpl(obj, v_in)
            ...
            try
                ...
                % Scale voltage to integer: multiply by 10000
                % e.g. 3.75V → 37500, -2.125V → -21250
                % Format: #sXXXXXX\n — 9 bytes total
                ...
                % Second value = voltage × 10000 (integer)
                timeout = 0.009;
                t_start = tic;
                ...
                if obj.SerialPort.NumBytesAvailable >= 17
                    ...
                    if numel(vals) == 2
                        ...
                        % Descale voltage back to real volts
        ...
        function releaseImpl(obj)
            try
                % Send zero voltage (0 × 10000 = 0) before closing
